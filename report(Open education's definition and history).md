...
## 1. The Context of Change and the Need for Educational Innovation

In times of change, unexpected events such as the COVID-19 pandemic have caused new social needs to emerge suddenly.
In such circumstances, educational systems face unanticipated challenges while simultaneously encountering new areas of opportunity.

At this moment, educational innovation serves as a catalyst for creating new technologies (devices, tools, prototypes),
services (care, support, benefits), and solutions (models, systems, methods).
...
To define and delimit the scope of educational innovation,
it is necessary to identify problematic situations, analyze their contexts,
and critically assess how these changes contribute to the improvement of education.

👉 Educational innovation includes any type of adaptation—organizational, administrative, pedagogical, or formative—
that enhances students’ learning outcomes.

In other words, educational innovation is a continuous and intentional process of transforming
the vision, actions, structure, components, and management of education.
...
Every study on educational innovation involves certain challenges.
The main actors—teachers, schools, and institutions—must prepare inclusive and transformative approaches
to respond effectively to new demands.

However, one major obstacle remains:
the traditional belief that educational innovation occurs only within formal institutions
...
within the broader framework of the Open Educational Movement.

The Open Education movement began with the simple idea of
sharing knowledge as a common good,
but it has evolved into a dynamic and continuously developing phenomenon.

Furthermore, Open Education has expanded beyond sharing;
it now functions as a complex educational practice that drives improvements
...
According to SciVal data, topics related to educational resources and online courses
